<x-app-layout>
    <style>
        ...
        .quiz-card:hover {
            ...
            box-shadow: 0 15px 30px rgba(61, 23, 174, 0.2);
        }
        ...
        .quiz-card::before {
            ...
            width: 100%;
            height: 5px;
            background: linear-gradient(90deg, #3D17AE, #7C3AED, #A855F7);
            background-size: 200% 100%;
            animation: rainbow 4s ease infinite;
        }
        
        /* Animasi Success Modal */
        .success-modal {
    ...
    <div class="container mx-auto p-6 bg-white h-full">
        ...
        <div x-data="{ showModal: true }"
            ...
            <div class="success-modal bg-white p-6 rounded-lg shadow-lg w-1/3 border-2 border-green-500">
                <div class="flex items-center">
                    <div class="mr-3 text-3xl">🎉</div>
                    <div>
                        <h2 class="text-xl font-semibold text-green-600">Success!</h2>
                        <p class="mt-1 text-gray-700">{{ session('success') }}</p>
                    </div>
                </div>
                <div class="mt-4 flex justify-end">
                    <button @click="showModal = false" 
                            class="px-4 py-2 bg-green-500 text-white rounded-md hover:bg-green-600 transition-all flex items-center">
                        OK <span class="ml-2">👌</span>
                    </button>
                </div>
            </div>
        </div>
            ...
            @foreach ($filteredQuizzes as $quiz)
                <div class="quiz-card grid-animation border rounded-lg text-[12px] text-[#808080] text-center p-[25px]">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="copied-message text-green-500 text-xs mt-1">Code Copied! ✨</div>
